...
```Bash
wget https://blzdistsc2-a.akamaihd.net/Linux/SC2.4.10.zip && unzip SC2.4.10.zip
...
```Bash
wget https://github.com/oxwhirl/smac/releases/download/v0.1-beta1/SMAC_Maps.zip && unzip SMAC_Maps.zip
...
```Bash
# 参考 commit/3d9e754720a95621bba6475c4d3b0d56fe919014
# 1. Install required packages for Linux
sudo apt-get install git cmake build-essential libgl1-mesa-dev libsdl2-dev \
    libsdl2-image-dev libsdl2-ttf-dev libsdl2-gfx-dev libboost-all-dev \
    libdirectfb-dev libst-dev mesa-utils xvfb x11vnc # python3-pip

pip install --upgrade pip setuptools psutil wheel
# 2. Install GFootball from PyPi package (recommended)
